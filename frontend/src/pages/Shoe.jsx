...
"Shoe Rack & Seat"
  ...
  const fetchProducts = async () => {
    try {
      ...
      const shoeProducts = response.data.filter((prod) => prod.category === "Shoe Racks");
      setProducts(shoeProducts);
      setFilteredProducts(sortProducts(shoeProducts, sortOption));
    } catch (error) {
