...
import "./beanbags.css"; // Import styles
...
const BeanBags = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const beanBagProducts = response.data.filter((prod) => prod.category === "Bean Bags");
      setProducts(beanBagProducts);
      setFilteredProducts(sortProducts(beanBagProducts, sortOption));
    } catch (error) {
    ...
    <div className="category-page">
      ...
      <div className="main-content">
        <div className="filters">
          {/* Bean Bag Type Filter */}
          <div className="filter-container">
            <label>Bean Bag Type:</label>
            <div className="type-links">
              {beanBagTypes.map((type) => (
                <span
                  key={type}
